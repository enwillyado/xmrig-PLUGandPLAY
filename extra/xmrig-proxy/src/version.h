...
#define APP_ID        "xmrig-proxy-eWa" APP_SSL_STR APP_DEBUG_STR
#define APP_NAME      "XMRig-proxy-eWa" APP_SSL_STR APP_DEBUG_STR
#define APP_DESC      "XMRig Stratum proxy-eWa" APP_SSL_STR APP_DEBUG_STR
#define APP_VERSION   "2.14.1-1"
